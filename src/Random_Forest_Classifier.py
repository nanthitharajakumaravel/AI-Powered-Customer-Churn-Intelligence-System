...
print("Improvement over baseline:", round(rf_acc - baseline_acc, 4))
...
print("\nTop Factors Influencing Churn (Random Forest):")
...
plt.barh(
    feature_imp['Feature'].head(10)[::-1],
    feature_imp['Importance'].head(10)[::-1]
)
